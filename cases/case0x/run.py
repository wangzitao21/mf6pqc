...
nlay, nrow, ncol = 50, 200, 1


# todo 案例目录
example_dir = './cases/case0x'
...
current_K_grid = np.load(os.path.join(example_dir, "./input_data/init_hk/hk_2_gaussian.npy")).reshape(nlay, nrow, ncol)
# current_K_grid = np.load(os.path.join(example_dir, "./input_data/init_hk/hk_4_zinnharvey_low.npy")).reshape(100, 400, 1)
# current_K_grid = np.load(os.path.join(example_dir, "./input_data/init_hk/hk_3_zinnharvey_high.npy")).reshape(100, 400, 1)
# current_K_grid = np.load(os.path.join(example_dir, "./input_data/init_hk/hk_1_single.npy")).reshape(100, 400, 1)
