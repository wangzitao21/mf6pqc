...
def create_and_run_models(
    ...
    # 溶质列表
    # species_list = ['H', 'O', 'Charge', 'C', 'Ca', 'Cl', 'Na', 'T']
    ...
    tdis = flopy.mf6.ModflowTdis(
        ...
        time_units='DAYS',
        nper=nper,
        perioddata=tdis_ds  # 第三个参数是tsmult
    )
    ...
    wel_spd_0 = [[(0, 0, 0), 2.839, 1.10684176e+02, 5.53421163e+01, 3.79645865e-16, 0.00001420, 0.0000, inflow_Cl_0, 0.005, inflow_T_0]]
    wel_spd_1 = [[(0, 0, 0), 2.839, 1.10684176e+02, 5.53421163e+01, 3.79645865e-16, 0.00001420, 0.0000, inflow_Cl_1, 0.005, inflow_T_1]]
    ...
    wel = flopy.mf6.ModflowGwfwel(
        ...
        stress_period_data={0: wel_spd_0,
                            1: wel_spd_1
                           },
