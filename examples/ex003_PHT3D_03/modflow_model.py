...
def build_model(
    *,
    ...
    flopy.mf6.ModflowGwfchd(
        ...
        pname="CHD-OUTFLOW",
        save_flows=True,
        auxiliary=["CHARGE_OUT"],
        stress_period_data={0: [[(0, 0, ncol - 1), outlet_head, 0.0]]},
    )
    ...
    for species_name, concentration in initial_fields.items():
        ...
        if species_name.casefold() == "charge":
            sources.append(("CHD-OUTFLOW", "AUXMIXED", "CHARGE_OUT"))
        flopy.mf6.ModflowGwtssm(gwt, sources=sources, filename=f"{gwt_name}.ssm")
