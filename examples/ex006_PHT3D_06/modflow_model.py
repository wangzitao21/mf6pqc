...
def build_model(
    *,
    ...
    flopy.mf6.ModflowTdis(
        simulation, pname="tdis", time_units="DAYS", nper=len(period_data), perioddata=period_data
    )
    ...
    wel_spd_0 = [[(0, 0, 0), inflow_rate, *pulse_concentrations]]
    wel_spd_1 = [[(0, 0, 0), inflow_rate, *chase_concentrations]]
