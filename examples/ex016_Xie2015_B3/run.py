...
import numpy as np
from ex016_Xie2015_B3.modflow_model import build_model
...
def main() -> None:
    ...
    simulation_config = SimulationConfig(
        ...
        output=OutputOptions(save_interval=14600, save_interval_offset=1, progress_interval=1000),
    )
    ...
    with MF6PQC.from_config(simulation_config) as simulator:
        ...
        require_output_files(output_dir, ("results.npy", "results_porosity.npy", "results_K.npy"))
        print("ex016 done.")
