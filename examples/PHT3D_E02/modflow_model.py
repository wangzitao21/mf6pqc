...
def transport_model(
    sim_ws="simulation", perlen=0.24, nstp=210, bc=None, species_list=None, initial_conc=None
):
    ...
    flopy.mf6.ModflowGwfnpf(
        gwf, pname="npf", save_flows=True, save_specific_discharge=True, icelltype=0, k=hk
    )
