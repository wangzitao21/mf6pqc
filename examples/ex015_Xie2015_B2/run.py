...
def main(argv=None):
    ...
    parser = argparse.ArgumentParser(
        description="Xie B2: implicit kinetic coupling",
    ...
    parser.add_argument("--kinetic-atol", type=float, default=1e-8)
    ...
    config = SimulationConfig(
        ...
        implicit=ImplicitOptions(
            ...
            chemical_jacobian="finite_difference",
