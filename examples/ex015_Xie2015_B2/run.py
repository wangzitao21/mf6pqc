...
from examples.ex015_Xie2015_B2.modflow_model import build_model
from mf6pqc import (
    MF6PQC,
    BackendPaths,
    CellFields,
...
SOLUTION_TOTALS = (
    {"Ca": 0.000169512, "C": 0.0002695, "S": 0.000169512, "Na": 0.00032},
    {"Ca": 0.0001, "C": 0.01, "S": 0.2, "Na": 0.39562},
)
...
def main():
    ...
    with MF6PQC.from_config(config) as sim:
        ...
        sim.run("Implicit")
        sim.save_results()
        print(f"B2 complete: {OUTPUT_DIR}")
