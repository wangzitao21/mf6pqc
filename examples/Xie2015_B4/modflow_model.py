...
def transport_model(
    ...
    gwf_model = flopy.mf6.ModflowGwf(sim, modelname=gwf_model_name, save_flows=True)
    ...
    bc_conc_map = dict(zip(species_list, bc, strict=False))
    ...
    for species_name, species_initial_conc in species_conc.items():
        ...
        flopy.mf6.ModflowGwtssm(gwt_model, pname="ssm", filename=f"{gwt_model_name}.ssm")
