...
def main() -> None:
    ...
    WORKSPACE = os.environ.get("MF6PQC_B4_WORKSPACE", runtime_path(__file__, "simulation"))
    OUTPUT_DIR = os.environ.get("MF6PQC_B4_OUTPUT_DIR", runtime_path(__file__, "output"))
