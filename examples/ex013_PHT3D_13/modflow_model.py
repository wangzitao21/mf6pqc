...
def build_model(
    *,
    ...
    flopy.mf6.ModflowTdis(simulation, time_units="DAYS", nper=2, perioddata=period_data)
    ...
    flopy.mf6.ModflowGwfsto(gwf, iconvert=0, ss=0.0, sy=0.0, steady_state={0: True, 1: True})
    flopy.mf6.ModflowGwfwel(
        ...
        maxbound=1,
        stress_period_data={
            0: [[(0, 0, 0), inflow_rate, *pulse_concentrations]],
            1: [[(0, 0, 0), inflow_rate, *chase_concentrations]],
        },
